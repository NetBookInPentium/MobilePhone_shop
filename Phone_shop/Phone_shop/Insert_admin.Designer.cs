namespace Phone_shop
{
	partial class Insert_admin
	{
		...
		private void InitializeComponent()
		{
			...
			this.button3.Location = new System.Drawing.Point(223, 171);
			...
			this.label3.Text = "Созать учетную запись";
			// 
			// label2
			// 
			...
			this.Name = "Insert_admin";
			this.Text = "Insert_admin";
